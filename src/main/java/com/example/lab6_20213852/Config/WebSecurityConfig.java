package com.example.lab6_20213852.Config;

import com.example.lab6_20213852.Repository.UsuarioRepository;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http.authorizeHttpRequests()
                .requestMatchers("/actualizarListaMesas","/vistaAgregarMesa","/vistaEditarMesa").hasAnyAuthority("Administrador")
                .requestMatchers("/reservas").hasAnyAuthority("Cliente","Gerente")
                .requestMatchers("/vistaAgregarReserva","/agregarReserva","/devolverReserva").hasAuthority("Cliente")
